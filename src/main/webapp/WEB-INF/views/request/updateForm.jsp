	...
	<div class="p-5">
		<form method="post" onsubmit="return false;"  enctype="multipart/form-data">
			...
			<div class="row mb-2 align-items-center">
				...
				<input name="srTtl" id="srTtl"class="col-sm-10" type="text" class="form-control form-control-sm" value="${sr.srTtl}"/>
			</div>
			<div class="row mb-2 align-items-center">
				<label class=" font-weight-bold col-sm-2">관련근거 </label> 
				<input name="srStd" id="srStd" class="col-sm-10" type="text" class="form-control form-control-sm" <c:if test="${sr.srStd ne undefined}"> value="${sr.srStd}"</c:if>/>
			</div>
			<div class="row mb-2">
					<label class=" font-weight-bold col-sm-2">SR 내용 </label> 
					<textarea name="srCn" id="srCn" rows="10" class="form-control form-control-sm col-sm-10" wrap="hard">${fn: replace(sr.srCn, "<br>","") } </textarea>
			...
			<div class="modal-footer justify-content-center">
		     	<button type="button" class="btn btn-outline-primary" onclick="getSrDetail('${sr.srNo}')">취소</button>
		       <button type="submit" class="btn btn-primary" onclick="requestUpdate()">저장</button>
		    </div>
		</form>

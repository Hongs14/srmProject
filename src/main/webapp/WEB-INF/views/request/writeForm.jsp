	...
	<div class="p-5">
		<form method="post" onsubmit="return false;"  enctype="multipart/form-data">
			...
			<div class="row mb-2">
					...
					<textarea name="srCn" id="sr_cn_textarea" rows="10" class="form-control form-control-sm col-sm-10" wrap="hard"><c:if test="${command eq 'update'}">${fn: replace(sr.srCn, "<br>","") } </c:if></textarea>
